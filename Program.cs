...
namespace CSharpExercises
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Assert("IsInLeapYear(2000) should return true", Exercises.IsInLeapYear(new DateTime(2000,1,1)) == true);
            Assert("IsInLeapYear(1904) should return true", Exercises.IsInLeapYear(new DateTime(1904,1,1)) == true);
            Assert("IsInLeapYear(1900) should return false", Exercises.IsInLeapYear(new DateTime(1900,1,1)) == false);
            Assert("IsInLeapYear(1901) should return false", Exercises.IsInLeapYear(new DateTime(1901,1,1)) == false);
